...
from .forms import DataExportForm, DeletionRequestForm, ProfileUpdateForm, RegisterForm
        ...
        if form.is_valid():
            ...
            data = {
                "utilisateur": {
                    ...
                    "consentement_date": (
                        user.consentement_date.isoformat() if user.consentement_date else None
                    ),
                },
