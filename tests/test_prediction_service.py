...
class TestCreatePrediction(TestCase):
    ...
    def test_create_prediction_success(self):
        ...
        with patch('predictions.services.prediction_service.api_client.predict',
...
class TestProcessBatchFromCsv(TestCase):
    ...
    def test_batch_success(self):
        ...
        from predictions.models import PredictionBatch, Prediction
        from predictions.services.prediction_service import process_batch_from_csv
        ...
        api_result = {'prix_estime': 300000, 'intervalle_bas': 270000,
                      'intervalle_haut': 330000, 'prix_m2': 4000,
                      'modele_version': 'v1', 'latence_ms': 10}

        with patch('predictions.services.prediction_service.api_client.predict_batch',
